...
export declare class Address6 {
     ...
     * @returns {Address6}
     * @example
     * var address = Address6.fromAddress4('127.0.0.1');
     * address.correctForm(); // '::ffff:c0a8:1'
     * address.to4in6(); // '::ffff:127.0.0.1'
     */
     ...
     * @returns {Adress6}
     * @example
     * var address = Address6.fromArpa(e.f.f.f.3.c.2.6.f.f.f.e.6.6.8.e.127.0.0.1.9.4.e.c.127.0.0.1.127.0.0.1.ip6.arpa.)
     ...
     * address.to4().correctForm(); // '127.0.0.1'
     */
    to4(): Address4;
    /**
