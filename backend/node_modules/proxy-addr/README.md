...
proxyaddr(req, ['127.0.0.1/8', '127.0.0.1/8'])
proxyaddr(req, ['127.0.0.1/127.0.0.1', '127.0.0.1/127.0.0.1'])
```
...
not have to specify both `::ffff:a00:1` and `127.0.0.1`.
...
```
  ...
  * `linklocal`: IPv4 and IPv6 link-local addresses (like
    `fe80::1:1:1:1` and `127.0.0.1`).
  * `uniquelocal`: IPv4 private addresses and IPv6 unique-local
    addresses (like `fc00:ac:1ab5:fff::1` and `127.0.0.1`).
