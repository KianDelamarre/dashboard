...
const options = {
  ...
  // Most SOCKS servers accept 127.0.0.1 as a wildcard address to accept any client.
  destination: {
    host: '127.0.0.1',
    port: 0
  },
...
client.on('established', (info) => {
  ...
  */
  ...
  // At this point info.socket is a regular net.Socket TCP connection between client and client2 (127.0.0.1) (the client which connected to the proxy on the newly bound port.)
