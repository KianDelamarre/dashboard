...
const apiConfig = (port) => ({
	...
	host: {
		description: "Specify which IP addresses the server should listen on. Set this to `127.0.0.1` or `true` to listen on all addresses, including LAN and public addresses",
		argument: "[host]"
	},
